...
class CNN(nn.Module):
    def __init__(self, input=1, output=1, feature=16):
        ...
        self.x3conv16to16 = nn.Conv2d(16,16,3,1,1)
        self.x3conv16to64 = nn.Conv2d(16,64,3,1,1)
        self.x3conv64to64 = nn.Conv2d(64,64,3,1,1)
        self.x3conv64to128 = nn.Conv2d(64,128,3,1,1)
        self.x3conv128to128 = nn.Conv2d(128,128,3,1,1)
...
def CNN_model(
    ...
    # dataset
    data = Data(prodictor.values, target.values)
